...
def getImageExifTime(time, fileNum)
	imageFile = '../../../../../ImageProcessing/1 - rawimages/090707_protrotroph_ribose_glycerol/time'<<time.to_s<<'_'<<fileNum.to_s<<'.jpg'
...
begin
	...
	filePlateMap = read384PlateFileNameMap('proto scan key02.csv');
