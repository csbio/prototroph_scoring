...
def getImageExifTime(time, fileNum)
	imageFile = 'H:/ImageProcessing/1 - rawimages/090710_bayanus_con-plate17/time'<<time.to_s<<'_'<<fileNum.to_s<<'.jpg'
...
begin
	...
	filePlateMap = read384PlateFileNameMap('protoscankey_p16.csv');
...
#		badFile = false if(badFile == nil);
		...
		print(YAML::dump(plateNumCondition));
