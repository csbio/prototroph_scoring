function [fit_data, aggregate, plate_layout, no_growth] = rate_measure_finalpix(colony_data)
%function [fit_data, aggregate, plate_layout, no_growth] = rate_measure_finalpix(colony_data)
% from rate_measure_slope. replace slope calculation with pixel-score for validation
